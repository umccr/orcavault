...
with incremental as (
    ...
    from {{ ref('link_library_external_subject') }}
    {% if is_incremental() %}
...
cdc_source as (
    ...
    select
        ...
        association_date,
        record_source
    from {{ ref('int_cdc_mm_historicallibrary_historicalsubject') }}
...
psa_source as (
    ...
    select distinct
        ...
        psa.external_subject_id                         as external_subject_id,
    ...
    where psa.library_id is not null
      and psa.library_id <> ''
      and psa.external_subject_id is not null
      and psa.external_subject_id <> ''
    ...
    select distinct
        ...
        gg.external_subject_id                          as external_subject_id,
    ...
    where gg.library_id is not null
      and gg.library_id <> ''
      and gg.external_subject_id is not null
      and gg.external_subject_id <> ''
    {% endif %}
